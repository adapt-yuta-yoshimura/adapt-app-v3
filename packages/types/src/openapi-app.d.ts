...
export interface components {
  schemas: {
    ...
    UserNotificationSettingView: {
      ...
      threadReplyEnabled: boolean;
      submissionCommentEnabled: boolean;
      gradingCompletedEnabled: boolean;
      liveReservedEnabled: boolean;
      adminAnnouncementEnabled: boolean;
    };
    /** @enum {string} */
    SurveyQuestionType: "rating" | "score" | "short_text" | "long_text" | "single_choice" | "multi_choice";
    SurveyOptionView: {
      id: string;
      label: string;
      value?: string | null;
    ...
    SurveyResponseCreateRequest: {
      answers: components["schemas"]["SurveyAnswerCreateRequest"][];
    };
  };
  responses: never;
  parameters: never;
...
export interface operations {
  ...
  API_007: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["UserNotificationSettingView"];
        };
      };
    };
  };
  ...
  API_023: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["SurveyDetailView"];
        };
      };
    };
  };
  ...
  API_024: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["SurveyResponseCreateRequest"];
      };
    };
    responses: {
      /** @description OK */
